...
import com.example.adminofbhojanalya.adapter.PendingOrderAdapter
import com.example.adminofbhojanalya.databinding.ActivityPendingOrderBinding
...
//handle dispatch and update database
    ...
    private fun deleteThisItemFromOrderDetails(dispatchItemPushKey: String) {
        ...
        orderDetailsItemsReference.removeValue()
            .addOnSuccessListener {
                Toast.makeText(this, "Order is prepared and ready to dispatch", Toast.LENGTH_SHORT).show()
    ...
    private fun updateOrderAcceptStatus(position: Int) {
        //update order  acceptance in user buy history order details
